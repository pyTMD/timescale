...
Welcome to the documentation for ``timescale``, Python tools for time and astronomical calculations
This documentation is intended to explain how to use the set of ``timescale`` utilities.
...
.. grid:: 2 2 4 4
    ...
    .. grid-item-card::  Discussions
      :text-align: center
      :link: https://github.com/pyTMD/timescale/discussions

      :material-outlined:`forum;5em`

    .. grid-item-card::  Issues
      :text-align: center
      :link: https://github.com/pyTMD/timescale/issues
